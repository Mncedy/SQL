...
🔍 SQL queries? Check them out here: [Data_Analyst_Jobs_EDA](/Data_Analyst_Jobs_EDA.sql)
...
From highest_paying_job hpj
	INNER JOIN skills_job_dim skd ON hpj.job_id = skd.job_id
...
## More SQL queries on Job Postings Dataset 🔍 Check them out here: [Data_Analyst_Job_aggreagate](/Data_Analyst_Job_aggregate.sql).
